...
<div class="span-12 last">
	...
	<div class="span-4 txt-right"><label class='txt-right' for="province">Province:</label></div>
...
<div class="span-8 last">
	<?php
	$num = str_pad(substr($this->data['Order']['credit_card_number'], -4), strlen($this->data['Order']['credit_card_number']), 'x', STR_PAD_LEFT);
	$num = chunk_split ($num, 4,' ');
	?>
	<?php echo $num;?>
</div>
<div class="clear"></div>
